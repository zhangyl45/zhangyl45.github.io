...
function createInstructions() {
	...
	'<span style="color:' + theme[0] + ';font-size:35px;">Zylon</span><br /><br /><span style="font-size:15px;"><strong>NET | H5 Coder</strong><br /><br />一个懵逼,茫然<br />不知所措<br />求收留の<br />程序员<br />小弟</span>'
	||randNum==2&&
